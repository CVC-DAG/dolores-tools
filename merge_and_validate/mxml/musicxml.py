...
@dataclass
class Distance:
    """The distance element represents standard distances between notation elements
    in tenths.
...
class Glyph:
    ...
    variations of symbols that are semantically identical.
...
class InstrumentLink:
    """Multiple part-link elements can link a condensed part within a score file to
    multiple MusicXML parts files.
...
class VirtualInstrument:
    """
    The virtual-instrument element defines a specific virtual instrument used for
    an instrument sound.
...
class Wait:
    ...
    performer event before continuing.
...
@dataclass
class Assess:
    """By default, an assessment application should assess all notes without a cue
    child element, and not assess any note with a cue child element.
...
class BeatUnitTied:
    ...
    is tied to the preceding beat-unit.
...
class Beater:
    """
    The beater type represents pictograms for beaters, mallets, and sticks that do
    not have different materials represented in the pictogram.
    """
...
@dataclass
class Double:
    """The double type indicates that the music is doubled one octave from what is
    currently written.
...
class EmptyPlacementSmufl:
    """
    The empty-placement-smufl type represents an empty element with print-style,
    placement, and smufl attributes.
    """
...
class EmptyPrintObjectStyleAlign:
    """
    The empty-print-style-align-object type represents an empty element with print-
    object and print-style-align attribute groups.
    """
...
class EmptyPrintStyleAlign:
    """
    The empty-print-style-align type represents an empty element with print-style-
    align attribute group.
    """
...
class FormattedTextId:
    """
    The formatted-text-id type represents a text element with text-formatting and
    id attributes.
    """
...
class HarmonyAlter:
    ...
    numeral, or bass of the current harmony-chord group within the harmony element.
...
@dataclass
class HoleClosed:
    """The hole-closed type represents whether the hole is closed, open, or half-
    open.
...
class HorizontalTurn:
    """The horizontal-turn type represents turn elements that are horizontal rather
    than vertical.
...
class Inversion:
    ...
    The value is a number indicating which inversion is used: 0 for root position, 1 for first inversion, etc.  The text attribute indicates how the inversion should be displayed in a score.
    """
...
@dataclass
class KeyOctave:
    """The key-octave type specifies in which octave an element of a key signature
    appears.
...
class LineDetail:
    ...
    individually specified with a line-detail type.
...
@dataclass
class NumeralKey:
    """The numeral-key type is used when the key for the numeral is different than
    the key specified by the key signature.
...
@dataclass
class NumeralRoot:
    """The numeral-root type represents the Roman numeral or Nashville number as a
...
class OctaveShift:
    ...
    type_value: Optional[UpDownStopContinue] = field(
        default=None,
        metadata={
            "name": "type",
            "type": "Attribute",
...
class OtherPlacementText:
    ...
    placement, and smufl attribute groups.
...
@dataclass
class Pedal:
    """The pedal type represents piano pedal marks, including damper and sostenuto
    pedal marks.

    The line attribute is yes if pedal lines are used. The sign
    attribute is yes if Ped, Sost, and * signs are used. For
    compatibility with older versions, the sign attribute is yes by
    default if the line attribute is no, and is no by default if the
    line attribute is yes. If the sign attribute is set to yes and the
    type is start or sostenuto, the abbreviated attribute is yes if the
    short P and S signs are used, and no if the full Ped and Sost signs
    are used. It is no by default. Otherwise the abbreviated attribute
    is ignored. The alignment attributes are ignored if the sign
    attribute is no.
    """
    ...
    type_value: Optional[PedalType] = field(
        default=None,
        metadata={
            "name": "type",
            "type": "Attribute",
...
class StaffDivide:
    """
    The staff-divide element represents the staff division arrow symbols found at
    SMuFL code points U+E00B, U+E00C, and U+E00D.
    """

    class Meta:
        name = "staff-divide"

    type_value: Optional[StaffDivideSymbol] = field(
        default=None,
        metadata={
            "name": "type",
            "type": "Attribute",
...
class StringMute:
    ...
    type_value: Optional[OnOff] = field(
        default=None,
        metadata={
            "name": "type",
            "type": "Attribute",
...
@dataclass
class Sync:
    """The sync type specifies the style that a score following application should
    use the synchronize an accompaniment with a performer.
    ...
    type_value: Optional[SyncType] = field(
        default=None,
        metadata={
            "name": "type",
            "type": "Attribute",
...
class Tied:
    ...
    type_value: Optional[TiedType] = field(
        default=None,
        metadata={
            "name": "type",
            "type": "Attribute",
...
@dataclass
class Unpitched:
    """The unpitched type represents musical elements that are notated on the staff
    but lack definite pitch, such as unpitched percussion and speaking voice.
...
class Credit:
    ...
    lyricist, copyright, dedication, and other text, symbols, and graphics that
    commonly appear on the first page of a score.
...
class Hole:
    """
    The hole type represents the symbols used for woodwind and brass fingerings as
    well as other notations.
...
class Listen:
    ...
    that a score following or machine listening application can interact with a
    performer.
...
@dataclass
class NoteheadText:
    """The notehead-text type represents text that is displayed inside a notehead,
    as is done in some educational music.
...
@dataclass
class Numeral:
    """The numeral type represents the Roman numeral or Nashville number part of a
    harmony.
...
@dataclass
class Defaults:
    """The defaults type specifies score-wide defaults for scaling; whether or not
    the file is a concert score; layout; and default values for the music font,
    word font, lyric font, and lyric language.
...
class Note:
    ...
    notation information (e.g., tie is used for sound, tied for notation). Thus
    grace notes do not have a duration element. Cue notes have a duration element,
    as do forward elements, but no tie elements. Having these two types of
    information available can make interchange easier, as some programs handle one
    type of information more readily than the other. The print-leger attribute is
    used to indicate whether leger lines are printed. Notes without leger lines are
    used to indicate indeterminate high and low notes. By default, it is set to
    yes. If print-object is set to no, print-leger is interpreted to also be set to
    no if not present. This attribute is ignored for rests.
